...
const employeesBonus = (arr) => {
    ...
    arr.forEach( function(ele){
    let salaryNum = parseInt(ele.salary.slice(0, ele.salary.length-1));
       
       
if(ele.workHours <=8)

ele.salary= salaryNum + 50 +"$"
else
ele.salary= salaryNum + 100 +"$"
...
mouseArray.forEach(function(ele){

keyBoardArray.forEach(function(val){
